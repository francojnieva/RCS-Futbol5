...
const reservationConfirmation = async (email) => {
    try {
        const info = await transporter.sendMail({
            ...
            <main style="text-align: center; font-family: 'Poppins', sans-serif;">
                ...
                <p style="font-family: 'Poppins', sans-serif, font-weight: 600;">N° de cancha: </p>
                <p style="font-family: 'Poppins', sans-serif, font-weight: 600;">Fecha y hora: </p>
